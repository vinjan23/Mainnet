...
mv lumerad $HOME/go/bin/lumerad $HOME/.lumera/cosmovisor/upgrades/v1.7.0/bin/
```
```
$HOME/.lumera/cosmovisor/upgrades/v1.7.0/bin/lumerad version --long | grep -e commit -e version
```
```
