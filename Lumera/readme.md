...
### Update
```
curl -LO https://github.com/LumeraProtocol/lumera/releases/download/v1.7.2/lumera_v1.7.2_linux_amd64.tar.gz
...
mv lumerad $HOME/go/bin/lumerad $HOME/.lumera/cosmovisor/upgrades/v1.7.2/bin/
```
```
