```
git ls-remote https://github.com/gnolang/gno.git refs/heads/chain/mainnet
```
### Binary
```
...
ExecStart=$(which gnoland) start --genesis $HOME/gno/gnoland-data/config/genesis.json --data-dir $HOME/gno/gnoland-data/ --chainid gnoland-1 --skip-genesis-sig-verification
Restart=always
RestartSec=3
LimitNOFILE=65535
[Install]
