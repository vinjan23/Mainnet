...
```
cd $HOME
wget https://github.com/planq-network/planq/releases/download/v2.0.5/planq_2.0.5_linux_amd64.tar.gz
tar -xvzf planq_2.0.5_linux_amd64.tar.gz
rm -rf planq_2.0.5_linux_amd64.tar.gz
