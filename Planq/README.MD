...
```
planqd tx distribution withdraw-rewards $(planqd keys show <key_name> --bech val -a) --commission --gas="1000000" --gas-adjustment="1.15" --gas-prices="30000000000aplanq" --chain-id planq_7070-2 --from <key_name>
```
