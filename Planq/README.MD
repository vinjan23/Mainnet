...
```
cd $HOME
wget https://github.com/planq-network/planq/releases/download/v2.0.4/planq_2.0.4_linux_amd64.tar.gz
tar -xvzf planq_2.0.4_linux_amd64.tar.gz
rm -rf planq_2.0.4_linux_amd64.tar.gz
